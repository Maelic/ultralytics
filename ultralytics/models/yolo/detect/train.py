...
class DetectionTrainer(BaseTrainer):
    ...
    def build_dataset(self, img_path: str, mode: str = "train", batch: int | None = None):
        ...
        # Auto-detect COCO annotation file for the current split (train_ann / val_ann / test_ann)
        ann_file = self.data.get(f"{mode}_ann")
        return build_yolo_dataset(
            self.args, img_path, batch, self.data, mode=mode, rect=mode == "val", stride=gs, ann_file=ann_file
        )
